...
class AblationProcess(Ablation):
    def __init__(self, lang):
        ...
        if lang == 'en':
            ...
            self.ablation_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../ablation/PerLTQA (EN)/'))
        elif lang == 'zh':
            ...
            self.ablation_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../ablation/PerLTQA (CN)/'))
        else:
    ...
    def ablation(self, sr_params, ab_stim, ab_lif, ab_prop):
        ...
        def process_section(section):
            ...
            for dialogue in dialogues:
                ...
                self.propagate_stimuli_ab(faiss, sr_sql, sr_data, cos_th, v_th, stimulus_th, tau_init, tau_scale, time_scale, bond_scale, v_rest, i_rest, ab_stim, ab_lif, ab_prop)
            results = []
