...
class SQL:
    ...
    def create_database(self) -> sqlite3.Connection:
        self.cursor.execute(f'CREATE TABLE IF NOT EXISTS {self.table_name} (id INTEGER PRIMARY KEY,vector TEXT, message TEXT, fire BOOLEAN, v REAL, i REAL, tau REAL, spike TEXT)')
        self.conn.commit()
        return self.conn
